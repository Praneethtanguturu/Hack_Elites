...
public class noodles extends JFrame
{
...
{
  public final int white_bagel=49;
  public final int wheat_bagel=39;
  ...
  public BagelPanel()
  {
    ...
    whitebagel=new JRadioButton("Noodles",true);
    wheatbagel=new JRadioButton("Maggi");
    ...
    //adding a border
    setBorder(BorderFactory.createTitledBorder("Noodles"));
...
class ToppingPanel extends JPanel
{
  ...
  public ToppingPanel()
  {
    ...
    check1=new JCheckBox("With Egg");
    check2=new JCheckBox("With Chicken");
    check3=new JCheckBox("Without Egg");
    check4=new JCheckBox("Without Chicken");
    ...
    setBorder(BorderFactory.createTitledBorder("Chicken Or Egg"));
...
class GreetingPanel extends JPanel
{
  ...
  {
    greeting=new JLabel("welocome to Brandi's Noodles House");
...
class CoffeePanel extends JPanel
{
  ...
  public CoffeePanel()
  {
    ...
    button2=new JRadioButton("Mushroom",true);
    button3=new JRadioButton("Panner");
    button4=new JRadioButton("Capsicum");
    ...
    setBorder(BorderFactory.createTitledBorder("vegiterian"));
    add(button1);
    add(button2);
    add(button3);
    add(button4);
